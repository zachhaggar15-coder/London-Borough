...
export const GENEVA_NEIGHBOURHOODS: GenevaNeighbourhood[] = [
  ...
  {
    id: "acacias",
    name: "Les Acacias & La Praille",
    borough: "Ville de Genève",
    centroid: { lat: 46.1900, lng: 6.1330 },
    travelBand: "inner",
    rent: { oneBedMedianGbp: 1800, twoBedMedianGbp: 2400, source: "market_review", asOf: AS_OF },
    roomDistrict: "geneve-rive-gauche",
    mainStations: [
      { name: "Genève-Lancy-Pont-Rouge", lines: ["Léman Express", "CFF"] },
      { name: "Les Acacias", lines: ["TPG tram 15", "TPG bus 11"] },
    ],
    lifestyle: {
      livelyVsQuiet: 5, greenSpace: 4, nightlife: 5, cafeDensity: 6, gymDensity: 6,
      walkability: 8, foodScene: 6, youngProfessionalDensity: 7, safety: 6, connectivity: 9,
    },
    summary:
      "Geneva's last industrial quarter, now the largest redevelopment site in the canton — the Praille-Acacias-Vernets plan will put twelve thousand homes on what is still mostly warehouses and car dealerships. It is the one part of the city where new stock is actually arriving.",
    strengths: [
      "New-build flats, which almost nowhere else in the canton has",
      "Pont-Rouge station and tram 15 on the doorstep",
      "Cheaper than anywhere comparable on the left bank",
      "Walk to Carouge and the Jonction",
    ],
    tradeoffs: [
      "A building site, and will be for another decade",
      "Industrial surroundings and heavy lorry traffic",
      "Almost no shops or green space yet",
      "Little of the character the older quarters have",
    ],
    dataQuality: "sourceBacked",
  },
  {
    id: "grottes",
    name: "Les Grottes & Montbrillant",
    borough: "Ville de Genève",
    centroid: { lat: 46.2140, lng: 6.1400 },
    travelBand: "central",
    rent: { oneBedMedianGbp: 1850, twoBedMedianGbp: 2450, source: "market_review", asOf: AS_OF },
    roomDistrict: "geneve-rive-droite",
    mainStations: [
      { name: "Genève-Cornavin", lines: ["CFF", "Léman Express"] },
      { name: "Les Grottes", lines: ["TPG bus 3", "TPG bus 5"] },
    ],
    lifestyle: {
      livelyVsQuiet: 6, greenSpace: 5, nightlife: 5, cafeDensity: 8, gymDensity: 5,
      walkability: 10, foodScene: 7, youngProfessionalDensity: 7, safety: 6, connectivity: 10,
    },
    summary:
      "Directly behind the main station, and the quarter Geneva very nearly demolished in the 1970s before the residents stopped it. What survived is the Schtroumpfs — a set of deliberately absurd organic-architecture buildings — and the most co-operatively minded neighbourhood in the city.",
    strengths: [
      "Two minutes from Cornavin and every train in the canton",
      "A genuine housing co-operative tradition and community",
      "Cheaper than the Pâquis for a quieter street",
      "Walk to the New Town, the Rhône and the station",
    ],
    tradeoffs: [
      "Railway noise on the northern edge",
      "Very little green space",
      "Small flats in old and co-operative stock",
      "Turnover is low, so almost nothing comes up",
    ],
    dataQuality: "sourceBacked",
  },
  {
    ...
    name: "Onex",
    borough: "Onex",
    centroid: { lat: 46.1840, lng: 6.1000 },
    travelBand: "outer",
    rent: { oneBedMedianGbp: 1600, twoBedMedianGbp: 2100, source: "market_review", asOf: AS_OF },
    roomDistrict: "onex-bernex",
    mainStations: [
      { name: "Onex-Cité", lines: ["TPG tram 14", "TPG bus 2"] },
      { name: "Genève-Lancy-Pont-Rouge", lines: ["Léman Express"] },
    ],
    lifestyle: {
      livelyVsQuiet: 4, greenSpace: 6, nightlife: 2, cafeDensity: 5, gymDensity: 5,
      walkability: 7, foodScene: 5, youngProfessionalDensity: 5, safety: 6, connectivity: 7,
    },
    summary:
      "A 1960s satellite town on the plateau west of the city, and the commune with the highest tax multiplier in the canton — roughly double Cologny's. That is the trade Onex makes: the cheapest Swiss-side rents after Vernier, and the largest slice of your salary taken by the commune.",
    strengths: [
      "Among the lowest rents on the Swiss side",
      "Tram 14 runs straight into the centre",
      "Generous green space between the blocks",
      "A real local centre with shops and a market",
    ],
    tradeoffs: [
      "The highest communal tax multiplier in the canton",
      "Large modernist estates in variable condition",
      "Twenty-five minutes to the centre",
      "Little to do in the evening",
    ],
    dataQuality: "sourceBacked",
  },
  {
    ...
    borough: "Plan-les-Ouates",
    centroid: { lat: 46.1670, lng: 6.1200 },
    travelBand: "outer",
    rent: { oneBedMedianGbp: 1750, twoBedMedianGbp: 2300, source: "market_review", asOf: AS_OF },
    roomDistrict: "plan-les-ouates",
    mainStations: [
      { name: "Plan-les-Ouates", lines: ["TPG tram 15", "TPG bus 22"] },
      { name: "Genève-Lancy-Bachet", lines: ["Léman Express"] },
    ],
    lifestyle: {
      livelyVsQuiet: 3, greenSpace: 7, nightlife: 2, cafeDensity: 5, gymDensity: 6,
      walkability: 6, foodScene: 5, youngProfessionalDensity: 6, safety: 8, connectivity: 7,
    },
    summary:
      "The watchmaking and life-sciences belt on the southern edge — Patek Philippe, Rolex and a cluster of biotech — with a village core that predates all of it. If you work in the ZIPLO industrial zone this is the obvious place to look, and almost nobody else does.",
    strengths: [
      "Walk or cycle to the watchmaking and biotech employers",
      "Tram 15 and the Bachet interchange",
      "Open country and the Salève view to the south",
      "A moderate communal tax multiplier",
    ],
    tradeoffs: [
      "Dominated by the industrial zone",
      "Twenty-five to thirty minutes to the centre",
      "Very little going on in the evening",
      "Car-oriented outside the village core",
    ],
    dataQuality: "sourceBacked",
  },
  {
    id: "cologny",
    name: "Cologny & Vandœuvres",
    borough: "Cologny",
    centroid: { lat: 46.2160, lng: 6.1780 },
    travelBand: "outer",
    rent: { oneBedMedianGbp: 2150, twoBedMedianGbp: 2900, source: "market_review", asOf: AS_OF },
    roomDistrict: "chenes",
    mainStations: [
      { name: "Cologny-Temple", lines: ["TPG bus A", "TPG bus 33"] },
      { name: "Genève-Eaux-Vives", lines: ["Léman Express"] },
    ],
    lifestyle: {
      livelyVsQuiet: 2, greenSpace: 9, nightlife: 1, cafeDensity: 4, gymDensity: 5,
      walkability: 6, foodScene: 5, youngProfessionalDensity: 3, safety: 10, connectivity: 5,
    },
    summary:
      "The lake terrace above Geneva, with the best views in the canton and the lowest communal tax multipliers in it. Cologny is where Byron wrote and where a great many people who could live anywhere have decided to, and the arithmetic of the tax rate is a large part of why.",
    strengths: [
      "Among the lowest communal tax rates in the canton",
      "Lake views and the Pré-Byron parkland",
      "Very large houses and gardens",
      "Ten minutes from the Eaux-Vives station by bus",
    ],
    tradeoffs: [
      "The most expensive rents anywhere in this section",
      "Almost no rental stock at any price",
      "Buses only, and not frequent ones",
      "Nothing whatsoever to walk to",
    ],
    dataQuality: "sourceBacked",
  },
  {
    ...
    name: "Cointrin",
    borough: "Le Grand-Saconnex",
    centroid: { lat: 46.2280, lng: 6.1050 },
    travelBand: "outer",
    rent: { oneBedMedianGbp: 1700, twoBedMedianGbp: 2250, source: "market_review", asOf: AS_OF },
    roomDistrict: "versoix-saconnex",
    mainStations: [
      { name: "Genève-Aéroport", lines: ["CFF", "Léman Express"] },
      { name: "Cointrin", lines: ["TPG bus 5", "TPG bus 28"] },
    ],
    lifestyle: {
      livelyVsQuiet: 3, greenSpace: 5, nightlife: 2, cafeDensity: 4, gymDensity: 5,
      walkability: 6, foodScene: 4, youngProfessionalDensity: 5, safety: 7, connectivity: 9,
    },
    summary:
      "Between the airport runway and the international quarter, which tells you both what it is good for and what is wrong with it. For anyone whose job involves a flight most weeks it is unbeatable, and for anyone who wants to sleep with the window open it is not.",
    strengths: [
      "The airport is a walk rather than a journey",
      "Quick to the UN quarter and to CERN",
      "Cheaper than Le Grand-Saconnex proper",
      "Direct trains from the airport station to anywhere in Switzerland",
    ],
    tradeoffs: [
      "Aircraft noise is severe and constant",
      "Very little local amenity",
      "Surrounded by airport infrastructure and roads",
  ...
  {
    id: "divonne",
    name: "Divonne-les-Bains & Gex",
    borough: "France voisine",
    centroid: { lat: 46.3570, lng: 6.1400 },
    travelBand: "fringe",
    rent: { oneBedMedianGbp: 900, twoBedMedianGbp: 1200, source: "market_review", asOf: AS_OF },
    roomDistrict: "france-gex",
    mainStations: [
      { name: "Divonne centre", lines: ["TPG bus F", "Ain Bus 811"] },
      { name: "Coppet", lines: ["Léman Express", "CFF"] },
    ],
    lifestyle: {
      livelyVsQuiet: 2, greenSpace: 10, nightlife: 2, cafeDensity: 5, gymDensity: 4,
      walkability: 6, foodScene: 6, youngProfessionalDensity: 3, safety: 9, connectivity: 4,
    },
    summary:
      "A French spa town at the foot of the Jura with a casino, a lake and a golf course, twenty minutes from the Swiss border and considerably further in feel. The Pays de Gex around it holds a large share of the CERN and international-organisation families.",
    strengths: [
      "The Jura for skiing and walking straight from the town",
      "French prices with Geneva salaries",
      "Genuinely attractive, with a thermal spa and lake",
      "Coppet station across the border for the Swiss rail network",
    ],
    tradeoffs: [
      "No railway; buses and car only",
      "Forty-five minutes to central Geneva at peak",
      "Border traffic in the morning is severe",
      "Expensive for the French side",
    ],
    dataQuality: "sourceBacked",
  },
  {
    ...
    name: "Coppet & Founex",
    borough: "Canton de Vaud",
    centroid: { lat: 46.3170, lng: 6.1930 },
    travelBand: "fringe",
    rent: { oneBedMedianGbp: 1700, twoBedMedianGbp: 2250, source: "market_review", asOf: AS_OF },
    roomDistrict: "vaud-nyon",
    mainStations: [
      { name: "Coppet", lines: ["Léman Express", "CFF"] },
      { name: "Founex village", lines: ["TPN bus 811"] },
    ],
    lifestyle: {
      livelyVsQuiet: 2, greenSpace: 9, nightlife: 1, cafeDensity: 5, gymDensity: 4,
      walkability: 7, foodScene: 5, youngProfessionalDensity: 4, safety: 10, connectivity: 7,
    },
    summary:
      "The first stop into Vaud along the lake, with a château, a small harbour and the Léman Express running every fifteen minutes into Cornavin. It is the standard answer for someone who wants Vaud's lower taxes without Nyon's size.",
    strengths: [
      "Vaud income tax, meaningfully below the canton of Geneva",
      "Fifteen minutes to Cornavin on a frequent train",
      "Lakeside, with a harbour and a village centre",
      "Several international schools within reach",
    ],
    tradeoffs: [
      "A different canton, so different rules and school system",
      "Very expensive for a village",
      "Almost nothing to do locally",
      "Peak trains into Geneva are crowded",
    ],
    dataQuality: "sourceBacked",
  },
];
