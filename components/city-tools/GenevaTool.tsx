...
/**
 * The Geneva and cross-border tool — the same component every other city renders,
...
const CITY_DATA = createCityData(
  getCityContent("geneva"),
  CITY_MAP_CONFIGS.geneva,
);

export default function GenevaTool() {
