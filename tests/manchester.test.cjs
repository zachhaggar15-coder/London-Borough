...
// The routing and content layer is no longer Manchester-specific: it is
// the shared factory in lib/city-content.ts, exercised for every city by
// tests/cities.test.cjs.
